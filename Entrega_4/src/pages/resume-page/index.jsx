            ...
            <header className="App-header">
                <div className="container-options">
                    ...
                    <table className="table-info">
                            <tr>
                                <td className="info"><b>Saldo Atual</b></td>
                                <td className="info">R$ xx,xx</td>
                            </tr>
                            <tr>
                                <td className="info"><b>Tipo de recarga</b></td>
                                <td className="info">Comum</td>
                            </tr>
                            <tr>
                                <td className="info"><b>Forma de pagamento</b></td>
                                <td className="info">Dinheiro</td>
                            </tr>
                            <tr>
                                <td className="info"><b>Valor da recarga</b></td>
                                <td className="info">R$ xx,xx</td>
                            </tr>
                            <tr>
                                <td className="info"><b>Saldo após a recarga</b></td>
                                <td className="info">R$ xx,xx</td>
                            </tr>
                    </table>
                    <Link to={'/insertmoney'} style={{ textDecoration: 'none', color: 'inherit' }}>
                        <button className='button-confirm'><span style={{ flex: '1', textAlign: 'center' }} className='cancel-title'>Confirmar</span></button>
                    </Link>
                </div>
